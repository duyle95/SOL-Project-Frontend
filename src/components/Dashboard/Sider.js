    ...
    switch (this.props.auth.user.role) {
      case 'admin':
        return [
          ...
          <Menu.Item
            key="2"
            onClick={() => this.props.history.push('/admin/replacement/all')}
          >
            <Icon type="form" />
      ...
      case 'basic':
        return [
          ...
          >
            <Menu.Item
              key="2"
              onClick={() => this.props.history.push('/basic/replacement/new')}
            >
              Fill in Replacement Form
            </Menu.Item>
            <Menu.Item
              key="3"
              onClick={() => this.props.history.push('/basic/replacement/all')}
            >
